  ...
  static async create(options: CodingAgentRuntimeOptions): Promise<CodingAgentRuntime> {
    ...
    try {
      ...
      const context = new ContextManager({
        ...
        ...(options.context?.compressAt === undefined
          ? {}
          : { compressAt: options.context.compressAt }),
        ...
        ...(options.context?.providerTranscriptPath === undefined ? {} : { providerTranscriptPath: options.context.providerTranscriptPath }),
      });
      ...
      const runtime = new CodingAgentRuntime({
        ...
        registry: new ToolRegistry(tools, {
          ...
          enforceStatBeforeRead: options.enforceStatBeforeRead,
          hooks,
        }),
