...
function createRunShellTool(manager: ProcessManager): Tool {
  return {
    definition: {
      name: "run_shell",
      description: "Run one complete shell command in the workspace and wait for it. File-system changes (mkdir, touch, rm, etc.) are immediately visible to list_files, stat_file, and read_file. The command may execute processes and access the network; no prefix is treated as safe.",
